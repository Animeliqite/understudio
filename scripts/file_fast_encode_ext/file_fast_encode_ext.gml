...
/// @param1 output_file
/// @param2 is_encoding
function file_fast_encode_ext(argument0, argument1, argument2) {
	...
	*/
	...
	var _data, _filename_in, _filename_out, _pos, _len, _is_encoding, _bit_shift, _shift_direction;
