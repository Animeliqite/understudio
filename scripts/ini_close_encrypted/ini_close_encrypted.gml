/// @description ini_close_encrypted(output_file, encryption_key_string);
/// @function ini_close_encrypted
/// @param0 output_file
/// @param1 encryption_key_string
function ini_close_encrypted(argument0, argument1) {
	...
	******** README *****************************************************
	...
	The purpose of this script is to encrypt .ini file in the computer's memory and save already encrypted file to the disk without creating the unencrypted copy.
	...
	*/
	...
	var _virtual_ini_string_lenght = string_length(_virtual_ini_string)
	//var _file_buffer = buffer_create(1, buffer_grow, 1); // Creating buffer for ini file data
	var _file_buffer = buffer_create(_virtual_ini_string_lenght, buffer_fixed, 1); // Creating buffer for ini file data

	buffer_seek(_file_buffer, buffer_seek_start, 0); // Setting 'seek' at the initial position
	buffer_write(_file_buffer, buffer_text, _virtual_ini_string); // Writing virtual ini data to the buffer
	// Getting DATA from virtual .ini to the buffer }}}
