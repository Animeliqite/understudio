...
function file_fast_crypt_ultra_zlib(argument0, argument1, argument2, argument3) {
...
-
	*/
	...
	_is_encrypting = argument2; // 1 - Compressing & Encrypting; 0 - Decrypting & Decompressing
